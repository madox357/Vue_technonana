      ...
      <div class="container">
        ...
        <div class="row text-center">
          ...
          <div class="col-md-4">
            ...
            <h4 class="service-heading">Plain HTML5,CSS & JavaScript</h4>
            <p class="text-muted">The original website written from scratch in plain html,css (tedious but fun); which cloned into the present website. Please find attached below source code for previous website. </p>
          </div>
          <div class="col-md-4">
            <span class="fa-stack fa-4x">
              <i class="fas fa-circle fa-stack-2x text-primary"></i>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            ...
            <h3 class="section-subheading text-muted">How I ended up developing cool websites.</h3>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-12">
              ...
              <li>
                ...
                <div class="timeline-panel">
                  ...
                  <div class="timeline-body">
                    <p class="text-muted">Undergraduate studies. Graduated Computer Systems BEng 2015 with honours.</p>
                  </div>
                </div>
              </li>
